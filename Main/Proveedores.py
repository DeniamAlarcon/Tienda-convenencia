...
class Proveedores:
    ...
    def leer_archivo(cls):
        archivo_proveedores = 'C:\\Users\\Deniam\\OneDrive\\Documentos\\GitHub\\Tienda-convenencia\\Archivos\\proveedores.csv'
        try:
            ...
            print(f'El archivo {archivo_proveedores} no se encuentra.')
        except csv.Error as e:
            print(f'Error al leer el archivo CSV')

    @classmethod
    def escribir_archivo_csv(cls):
        ruta_csv = 'C:\\Users\\Deniam\\OneDrive\\Documentos\\GitHub\\Tienda-convenencia\\Archivos\\reporte_proveedores_csv.csv'
        try:
    ...
    def escribir_archivo_json(cls):
        ruta_json = 'C:\\Users\\Deniam\\OneDrive\\Documentos\\GitHub\\Tienda-convenencia\\Archivos\\reporte_proveedores_json.json'
    ...
    def escribir_archivo_pdf(cls):
        archivo_pdf = 'C:\\Users\\Deniam\\OneDrive\\Documentos\\GitHub\\Tienda-convenencia\\Archivos\\reporte_proveedores_pdf.pdf'
    ...
    def escribir_archivo_xlsx(cls):
        archivo_xlsx = 'C:\\Users\\Deniam\\OneDrive\\Documentos\\GitHub\\Tienda-convenencia\\Archivos\\reporte_proveedores_xlsx.xlsx'
